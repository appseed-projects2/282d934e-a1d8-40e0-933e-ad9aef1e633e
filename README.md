...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-12 13:36`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/282d934e-a1d8-40e0-933e-ad9aef1e633e.git
$ cd 282d934e-a1d8-40e0-933e-ad9aef1e633e
```
